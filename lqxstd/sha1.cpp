...
void lqx::CSHA1::Transform(UINT_32* pState, const UINT_8* pBuffer)
{
...
void lqx::CSHA1::Update(const UINT_8* pbData, UINT_32 uLen)
{
...
bool lqx::CSHA1::HashFile(const TCHAR* tszFileName)
{
...
#ifdef SHA1_UTILITY_FUNCTIONS
bool lqx::CSHA1::ReportHash(TCHAR* tszReport, REPORT_TYPE rtReportType) const
{
...
bool lqx::CSHA1::ReportHashStl(std::basic_string<TCHAR>& strOut, REPORT_TYPE rtReportType) const
{
	TCHAR tszOut[84];
...
bool lqx::CSHA1::GetHash(UINT_8* pbDest20) const
{
